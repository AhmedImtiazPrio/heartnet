...
features = (features-mu)./sigma1;

%% Running classify to obtain the final classification result for the current recording
predictor = boostedHII_predict(features,cvres_full.clf_full,'probability');
if predictor > thr
    classifyResult = 1;
else
    classifyResult = -1;
...
%classifyResult = classify(features,mu,sigma1);
end
%%%%%%
%%
