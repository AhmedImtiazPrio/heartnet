...
function assigned_states = runSpringerSegmentationAlgorithmpython(audio_data, Fs)
...
B_matrix=load('Springer_B_matrix.mat');
B_matrix=B_matrix.Springer_B_matrix;
pi_vector=load('Springer_pi_vector.mat');
pi_vector=pi_vector.Springer_pi_vector;
total_observation_distribution=load('Springer_total_obs_distribution.mat');
total_observation_distribution=total_observation_distribution.Springer_total_obs_distribution;
