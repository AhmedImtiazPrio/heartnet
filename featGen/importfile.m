function wav = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   WAV = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   WAV = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   wav = importfile('wav.tsv', 2, 3836);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/12/05 12:00:37
...
wav = table(dataArray{1:end-1}, 'VariableNames', {'file_name','label'});
